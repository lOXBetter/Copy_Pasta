   ...
   $htmlNavbar = @"
    <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Azure Resources</a>
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="resourceGroupDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Resource Group
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="resourceGroupDropdown" id="resourceGroupFilter">
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="regionDropdown" id="regionFilter">
                        </ul>
                    </li>
                </ul>
            </div>
...
"@
    ...
    Get-ChildItem $currentdirectory | ForEach-Object {
        ...
        Get-ChildItem $resourceGroupPath -Filter "*.json" | ForEach-Object {
            ...
            $isActive = if ($tabIndex -eq 0) { 'active' } else { '' }
            $htmlContent += @"
            <li class="nav-item" role="presentation">
                <a class="nav-link $isActive" id="tab$tabIndex" data-bs-toggle="tab" href="#content$tabIndex" role="tab" aria-controls="content$tabIndex" aria-selected="true">$($_.BaseName)</a>
            </li>
"@
